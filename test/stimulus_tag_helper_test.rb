...
class StimulusTagHelperTest < TestCase
  ...
  def test_scontrollers_properties
    assert_equal(expected_controller_poperty, t.stimulus_controllers_property(singular_input[:controller]))
    assert_equal(expected_controllers_property, t.stimulus_controllers_property(*plural_input[:controllers]))
  end

  def test_values_properties
    assert_equal(expected_value_property, t.stimulus_value_property("clipboard", **singular_input[:value]))
  ...
  def test_classes_properties
    assert_equal(expected_class_property, t.stimulus_class_property("clipboard", **singular_input[:class]))
  ...
  def test_targets_properties
    assert_equal(expected_target_property, t.stimulus_target_property("clipboard", singular_input[:target]))
  ...
  def test_actions_property
    assert_equal(expected_action_property, t.stimulus_action_property("clipboard", singular_input[:action]))
